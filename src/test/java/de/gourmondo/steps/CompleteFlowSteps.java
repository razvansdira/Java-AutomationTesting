...
public class CompleteFlowSteps extends ScenarioSteps{
    ...
    @Step
    public void clickOnCartIcon() {headerPage.clickOnCart();}
    ...
    @Step
    public void setStreet(String name){addressPage.inputStreet(name);}

    @Step
    public void setNumber(String no){addressPage.inputNumber(no);}

    @Step
    public void setPostCode(String pcode){addressPage.inputPostCode(pcode);}

    @Step
    public void setCity(String town){addressPage.inputCity(town);}

    @Step
    public void send(){addressPage.submitForm();}

    @Step
    public void next(){addressPage.clickContinue();}

    @Step
    public void nextDelivery(){addressPage.passDelivery();}

    @Step
    public void nextPayment(){addressPage.passPayment();}
